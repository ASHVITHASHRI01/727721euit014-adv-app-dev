...
const Home = () => {
  ...
  //     if (yogaPicRef.current) {
  //         observer.observe(yogaPicRef.current);
  //     }

  //     return () => {
  //         if (yogaPicRef.current) {
  //             observer.unobserve(yogaPicRef.current);
  //         }
  //     };
  // }, [yogaPicRef]);
  // last message pic
  ...
  return (
      ...
      <div className="content-container">
          ...
          <div className='home-right'>
              <div className="home-section">
                ...
                {/* https://img.freepik.com/free-photo/lifestyle-wellbeing-sport-concept-woman-sitting-gym-flo_197531-30752.jpg?w=900&t=st=1706207505~exp=1706208105~hmac=0be0601d8375074dcdb6247cd67b61a87f6844b7390d942629142a091de7ae34" alt="Image" height='486vh' width='757vh' /> */}
              </div> 
          </div>
      </div>
      ...
      <section className="news-home">
        <h1>NEWS</h1>
          ...
          {/* <a className="btn-primary">FIND A CLASS</a> */}
        </section>
        <br></br>
      ...
      <div className="gallery-item">
        ...
        <strong><p>Image 1 Name</p></strong>
      </div>

      <div className="gallery-item">
        <a href="link-to-image-4">
