...
const AddAcademy = () => {
  ...
  const handleAddAcademy = async (e) => {
    ...
    try {
      ...
      const response = await axios.post( 'http://localhost:8080/api/v1/auth/postaca',
        {
          name: academyName,
          email: email,
          phonenumber: phone,
      ...
      <div className='movecourse'>
        <div className="add-course-container">
          ...
          <form onSubmit={handleAddAcademy}>
            <label className="form-label"> Academy Name:
              <input type="text" value={academyName} onChange={(e) => setAcademyName(e.target.value)} className="form-input" />
            </label>
...
// const AddAcademy = () => {
//   const [academyName, setAcademyName] = useState('');
//   const [academyDuration, setAcademyDuration] = useState('');
...
//               <input
//                 type="text"
//                 value={academyDuration}
//                 onChange={(e) => setAcademyDuration(e.target.value)}
//                 className="form-input"
//               />
//             </label>
//             <label className="form-label">
